...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'https://github.com/particleHorizon/PodComponent.git', :tag => '0.1.3' }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '9.0'

  s.source_files = 'PodUtil/PodUtil/*'
  
  s.public_header_files = 'PodUtil/PodUtil/*.h'
  
  # s.vendored_libraries = 'PodUtil.a'
